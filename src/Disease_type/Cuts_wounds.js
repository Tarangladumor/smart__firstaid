...
export default function Cuts_wounds() {
  return (
    <div>
      ...
      <h1 className='main_heading_cuts'>Cuts and Wounds</h1>
      ...
      <h2 className="bits_h2">Abrasions</h2>
      <p className="bits_p">Abrasions are injuries to the skin caused by rubbing or scraping against a rough surface. They can result in pain, bleeding, and scab formation.</p>

                  <li>A basic example of an abrasion can be a rug burn obtained from sliding across a carpeted floor.</li>
